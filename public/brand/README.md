...
| `pedigo-logo-light.svg` | Landing y fondos claros | **SVG** | Ancho ~**240–320** px en diseño |
| `pedigo-logo-dark.svg` | Modo oscuro, header dark | **SVG** | Misma proporción que light |
